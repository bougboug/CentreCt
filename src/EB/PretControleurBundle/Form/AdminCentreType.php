...
class AdminCentreType extends AbstractType
{
    /**
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
           ...
           // ->add('dateCreation','date', array('widget' => 'single_text','format' => 'yyyy-MM-dd','required' => false))
            ->add('dateCreation','date',array('widget' => 'single_text','format' => 'dd-MM-yyyy','required' => false,'attr' => array('class' => 'date')))
    ...
    {
        return 'eb_pretcontroleurbundle_admin_centre';
    }
}
